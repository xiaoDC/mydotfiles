...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (act2          (if (eq variant 'dark) (if (true-color-p) "#222226" "#444444") (if (true-color-p) "#d3d3e7" "#afafd7")))
        ...
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#225d7f" "#444444") (if (true-color-p) "#d3d3e7" "#d7d7ff")))
